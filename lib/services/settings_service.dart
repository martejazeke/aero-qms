...
class SettingsService extends ChangeNotifier {
  ...
  String _defaultCourtType = 'doubles';
  ...
  String get defaultCourtType => _defaultCourtType;
  ...
  Future<void> init() async {
    ...
    _defaultCourtType = _prefs.getString('defaultCourtType') ?? 'doubles';
    notifyListeners();
  }
  ...
  Future<void> setDefaultCourtType(String type) async {
    _defaultCourtType = type;
    await _prefs.setString('defaultCourtType', type);
    notifyListeners();
  }
